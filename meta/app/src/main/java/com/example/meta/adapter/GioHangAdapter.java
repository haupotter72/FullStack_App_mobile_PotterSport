...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.item_sizegiay.setText(gioHang.getSize()+"");
        Glide.with(context).load(gioHang.getHinhAnh()).into(holder.item_giohang_image);
        holder.item_giohang_gia.setText(gioHang.getDonGia() + "đ");
           ...
           public void onImageClick(View view, int pos, int giatri) {
               ...
               if(giatri == 1){
                   if(gioHangList.get(pos).getSoLuong() > 1){
                       ...
                       holder.item_sizegiay.setText(gioHangList.get(pos).getSize() + " ");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView item_giohang_tensp,item_giohang_gia,item_giohang_soluong, item_giohang_giasp2,item_sizegiay;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            item_sizegiay =  itemView.findViewById(R.id.item_size_giay);
